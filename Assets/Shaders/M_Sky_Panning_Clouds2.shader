		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.085177,0.153746,0.350000,1.000000);//Zenith Color
	Material.VectorExpressions[2] = float4(0.085177,0.153746,0.350000,0.000000);//(Unknown)
	Material.VectorExpressions[3] = float4(0.940601,1.000000,1.000000,1.000000);//Horizon color
	Material.VectorExpressions[4] = float4(0.940601,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[5] = float4(-2.000000,0.000000,-1.000000,1.000000);//Light direction
	Material.VectorExpressions[6] = float4(-2.000000,0.000000,-1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(-0.894427,0.000000,-0.447214,0.000000);//(Unknown)
	Material.VectorExpressions[8] = float4(1.000000,0.800000,0.400000,1.000000);//Sun color
	Material.VectorExpressions[9] = float4(1.000000,0.800000,0.400000,0.000000);//(Unknown)
	Material.VectorExpressions[10] = float4(50.000000,40.000000,20.000000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.716850,0.782221,0.885000,0.000000);//Cloud color
	Material.VectorExpressions[12] = float4(0.716850,0.782221,0.885000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.100000,1.000000,3.000000,5.000000);//Stars brightness Sun height Horizon Falloff (Unknown)
	Material.ScalarExpressions[1] = float4(2.236068,0.000300,0.000300,3333.333252);//(Unknown) Sun Radius (Unknown) (Unknown)
	Material.ScalarExpressions[2] = float4(50.000000,0.100000,1.000000,4.000000);//Sun brightness Cloud speed Cloud opacity NoisePower2
