		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.177888,0.177888,0.177888,0.560784);//TintColor
	Material.VectorExpressions[3] = float4(0.177888,0.177888,0.177888,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.560784,1.000000,5.000000,1.000000);//OpacityAndRefraction
	...
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,1.000000,0.560784);//SpecularAmount RoughnessAmount (Unknown) (Unknown)
