Shader "Unreal/MI_PlasticMatteBlack"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.010960,0.010960,0.010960,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.010960,0.010960,0.010960,0.000000);//(Unknown)
