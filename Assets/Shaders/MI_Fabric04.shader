		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.009721,0.009721,0.009721,0.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.009721,0.009721,0.009721,0.000000);//(Unknown)
	...
	Material.VectorExpressions[9] = float4(0.000000,0.000000,5.000000,5.000000);//UVOffsetAndScale
	Material.VectorExpressions[10] = float4(0.000000,0.000000,5.000000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.000000,0.000000,5.000000,5.000000);//(Unknown)
	Material.VectorExpressions[12] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[13] = float4(5.000000,5.000000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,6500.000000,0.000000);//UVRotation NormalMapAmount ColorTemperature LuminanceAmount
	...
	Material.ScalarExpressions[3] = float4(0.000000,5.000000,0.000000,0.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
}
