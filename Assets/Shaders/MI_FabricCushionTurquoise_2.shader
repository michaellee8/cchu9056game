Shader "Unreal/MI_FabricCushionTurquoise_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.366253,0.708376,0.496933,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.366253,0.708376,0.496933,0.000000);//(Unknown)
	...
	Material.VectorExpressions[9] = float4(0.000000,0.000000,0.050000,0.050000);//UVOffsetAndScale
	Material.VectorExpressions[10] = float4(0.000000,0.000000,0.050000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.000000,0.000000,0.050000,0.050000);//(Unknown)
	Material.VectorExpressions[12] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[13] = float4(0.050000,0.050000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,0.500000,6500.000000,0.000000);//UVRotation NormalMapAmount ColorTemperature LuminanceAmount
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,1.500000,1.000000);//(Unknown) MetallicAmount RoughnessAmount (Unknown)
	Material.ScalarExpressions[2] = float4(0.500000,0.500000,1.000000,0.000000);//(Unknown) (Unknown) AlphaOpacityMask (Unknown)
	Material.ScalarExpressions[3] = float4(0.000000,0.050000,0.000000,0.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
}
