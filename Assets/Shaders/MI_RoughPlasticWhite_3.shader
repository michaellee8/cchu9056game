Shader "Unreal/MI_RoughPlasticWhite_3"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.558341,0.558341,0.558341,0.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.558341,0.558341,0.558341,0.000000);//(Unknown)
	...
	Material.VectorExpressions[9] = float4(0.000000,0.000000,3.000000,3.000000);//UVOffsetAndScale
	Material.VectorExpressions[10] = float4(0.000000,0.000000,3.000000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.000000,0.000000,3.000000,3.000000);//(Unknown)
	Material.VectorExpressions[12] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[13] = float4(3.000000,3.000000,0.000000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,1.250000,1.000000);//(Unknown) MetallicAmount RoughnessAmount (Unknown)
	Material.ScalarExpressions[2] = float4(0.250000,0.250000,1.000000,0.000000);//(Unknown) (Unknown) AlphaOpacityMask (Unknown)
	Material.ScalarExpressions[3] = float4(0.000000,3.000000,0.000000,0.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
}
