Shader "Unreal/Object_LightGray_"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.396755,0.396755,0.396755,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.396755,0.396755,0.396755,0.000000);//(Unknown)
