		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.395142,0.609375,0.323730,1.000000);//ColorTint_Summer
	Material.VectorExpressions[3] = float4(0.395142,0.609375,0.323730,0.000000);//(Unknown)
	...
	Material.VectorExpressions[6] = float4(0.348958,0.242298,0.049072,1.000000);//ColorTint_Autumn
	Material.VectorExpressions[7] = float4(0.348958,0.242298,0.049072,0.000000);//(Unknown)
