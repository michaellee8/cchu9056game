Shader "Unreal/Translucent_Glass_Block_Light_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[9] = float4(0.000000,0.000000,0.083333,0.083333);//UVOffsetAndScale
	Material.VectorExpressions[10] = float4(0.000000,0.000000,0.083333,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.000000,0.000000,0.083333,0.083333);//(Unknown)
	Material.VectorExpressions[12] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[13] = float4(0.083333,0.083333,0.000000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[3] = float4(0.000000,0.083333,0.000000,0.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
}
