Shader "Unreal/MI_FabricCushion11"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.119538,0.854993,0.462077,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.119538,0.854993,0.462077,0.000000);//(Unknown)
