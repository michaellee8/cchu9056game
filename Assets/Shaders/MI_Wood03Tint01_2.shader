Shader "Unreal/MI_Wood03Tint01_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.760525,0.296138,0.093059,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.760525,0.296138,0.093059,0.000000);//(Unknown)
