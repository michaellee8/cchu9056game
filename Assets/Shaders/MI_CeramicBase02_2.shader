Shader "Unreal/MI_CeramicBase02_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.212231,0.000000,0.234551,0.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.212231,0.000000,0.234551,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,0.250000,0.250000);//(Unknown) MetallicAmount RoughnessAmount (Unknown)
	Material.ScalarExpressions[2] = float4(-0.750000,0.000000,1.000000,0.000000);//(Unknown) (Unknown) AlphaOpacityMask (Unknown)
