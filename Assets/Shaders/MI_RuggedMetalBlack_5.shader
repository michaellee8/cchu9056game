Shader "Unreal/MI_RuggedMetalBlack_5"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.030713,0.030713,0.030713,0.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.030713,0.030713,0.030713,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.000000,1.000000,6500.000000,0.000000);//UVRotation NormalMapAmount ColorTemperature LuminanceAmount
