Shader "Unreal/MI_FabricCottonLightGreen"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.304987,0.496933,0.070360,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.304987,0.496933,0.070360,0.000000);//(Unknown)
