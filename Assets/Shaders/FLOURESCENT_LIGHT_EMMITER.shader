Shader "Unreal/FLOURESCENT_LIGHT_EMMITER"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.955973,1.000000,0.955973,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.955973,1.000000,0.955973,0.000000);//(Unknown)
