Shader "Unreal/MI_Woodchips02_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[9] = float4(0.000000,0.000000,0.800000,0.800000);//UVOffsetAndScale
	Material.VectorExpressions[10] = float4(0.000000,0.000000,0.800000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.000000,0.000000,0.800000,0.800000);//(Unknown)
	Material.VectorExpressions[12] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[13] = float4(0.800000,0.800000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,2.000000,6500.000000,0.000000);//UVRotation NormalMapAmount ColorTemperature LuminanceAmount
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,1.800000,1.000000);//(Unknown) MetallicAmount RoughnessAmount (Unknown)
	Material.ScalarExpressions[2] = float4(0.800000,0.800000,1.000000,0.000000);//(Unknown) (Unknown) AlphaOpacityMask (Unknown)
	Material.ScalarExpressions[3] = float4(0.000000,0.800000,0.000000,0.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
}
