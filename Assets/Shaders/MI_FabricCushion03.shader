Shader "Unreal/MI_FabricCushion03"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.327778,0.693872,1.000000,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.327778,0.693872,1.000000,0.000000);//(Unknown)
