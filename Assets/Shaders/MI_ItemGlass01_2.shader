Shader "Unreal/MI_ItemGlass01_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.100000,1.520000,2.000000,0.100000);//OpacityAndRefraction
	...
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,0.100000,0.100000);//SpecularAmount RoughnessAmount (Unknown) (Unknown)
	Material.ScalarExpressions[2] = float4(1.520000,-0.520000,2.520000,-0.206349);//(Unknown) (Unknown) (Unknown) (Unknown)
	Material.ScalarExpressions[3] = float4(0.042580,2.000000,0.957420,0.100000);//(Unknown) (Unknown) (Unknown) (Unknown)
