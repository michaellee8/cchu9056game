		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.300000,1.000000,5.000000,1.000000);//OpacityAndRefraction
	...
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,1.000000,0.300000);//SpecularAmount RoughnessAmount (Unknown) (Unknown)
