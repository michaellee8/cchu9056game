Shader "Unreal/MI_Redcedar06G_5"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.672443,0.246201,0.095307,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.672443,0.246201,0.095307,0.000000);//(Unknown)
