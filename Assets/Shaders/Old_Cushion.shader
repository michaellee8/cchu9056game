Shader "Unreal/Old_Cushion"
{
	Properties
	{
		...
		Material_Texture2D_4( "RoughnessMap", 2D ) = "white" {}
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.000000,0.000000,0.000000,0.000000);//UVSpeed
	...
	Material.VectorExpressions[4] = float4(0.000000,0.000000,1.000000,1.000000);//UVOffsetAndScale
	Material.VectorExpressions[5] = float4(0.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[6] = float4(0.000000,0.000000,1.000000,1.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[8] = float4(1.000000,1.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[9] = float4(1.000000,1.000000,1.000000,0.000000);//LuminanceFilter
	Material.VectorExpressions[10] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[12] = float4(1.000000,1.000000,1.000000,0.000000);//TintColor
	Material.VectorExpressions[13] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,1.000000,0.000000,0.000000);//UVRotation NormalMapAmount (Unknown) (Unknown)
	Material.ScalarExpressions[1] = float4(1.000000,6500.000000,0.000000,0.000000);//(Unknown) ColorTemperature LuminanceAmount (Unknown)
	Material.ScalarExpressions[2] = float4(1.000000,1.000000,0.000000,0.000000);//RoughnessAmount (Unknown) (Unknown) (Unknown)
	Material.ScalarExpressions[3] = float4(0.500000,1.000000,1.000000,0.000000);//Subsurface_Opacity AlphaOpacityMask Subsurface_ColorFactor __SubsurfaceProfile
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local47 = (View.GameTime * Material.ScalarExpressions[0].z);
	MaterialFloat Local48 = (View.GameTime * Material.ScalarExpressions[0].w);
	MaterialFloat2 Local49 = ((MaterialFloat2(0.50000000,0.50000000) * -1.00000000) + Parameters.TexCoords[0].xy);
	MaterialFloat Local50 = dot(Local49, MaterialFloat2(Local34.g,Local35));
	MaterialFloat Local51 = dot(Local49, Local34);
	MaterialFloat2 Local52 = (MaterialFloat2(0.50000000,0.50000000) + MaterialFloat2(Local50,Local51));
	MaterialFloat2 Local53 = (Material.VectorExpressions[7].rg + Local52);
	MaterialFloat2 Local54 = (Material.VectorExpressions[8].rg * Local53);
	MaterialFloat2 Local55 = (MaterialFloat2(Local47,Local48) + Local54);
	MaterialFloat Local56 = MaterialStoreTexCoordScale(Parameters, Local55, 4);
	MaterialFloat4 Local57 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_1, GetMaterialSharedSampler(Material_Texture2D_1Sampler,View.MaterialTextureBilinearWrapedSampler),Local55));
	MaterialFloat Local58 = MaterialStoreTexSample(Parameters, Local57, 4);
	MaterialFloat3 Local59 = MaterialExpressionBlackBody(Material.ScalarExpressions[1].y);
	MaterialFloat Local60 = dot(Local59, Local59);
	MaterialFloat Local61 = sqrt(Local60);
	MaterialFloat3 Local62 = (Local59 / Local61);
	MaterialFloat3 Local63 = (Material.VectorExpressions[10].rgb * Local62);
	MaterialFloat3 Local64 = (Material.ScalarExpressions[1].z * Local63);
	MaterialFloat3 Local65 = (Local57.rgb * Local64);
	MaterialFloat3 Local66 = lerp(Local65,Material.VectorExpressions[11].rgb,MaterialFloat(Material.ScalarExpressions[1].w));
	MaterialFloat Local67 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 1);
	MaterialFloat4 Local68 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_2, GetMaterialSharedSampler(Material_Texture2D_2Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
	MaterialFloat Local69 = MaterialStoreTexSample(Parameters, Local68, 1);
	MaterialFloat3 Local70 = (Local68.rgb * Material.VectorExpressions[13].rgb);
	MaterialFloat Local71 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 2);
	MaterialFloat4 Local72 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_3, GetMaterialSharedSampler(Material_Texture2D_3Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
	MaterialFloat Local73 = MaterialStoreTexSample(Parameters, Local72, 2);
	MaterialFloat3 Local74 = lerp(Local68.rgb,Local70,Local72.rgb);
	MaterialFloat Local75 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 3);
	MaterialFloat4 Local76 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_4, GetMaterialSharedSampler(Material_Texture2D_4Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
	MaterialFloat Local77 = MaterialStoreTexSample(Parameters, Local76, 3);
	MaterialFloat3 Local78 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Local76.rgb,MaterialFloat(Material.ScalarExpressions[2].y));
	MaterialFloat3 Local79 = lerp(Local78,MaterialFloat3(1.00000000,1.00000000,1.00000000),MaterialFloat(Material.ScalarExpressions[2].w));
	MaterialFloat Local80 = lerp(1.00000000,Local68.a,Material.ScalarExpressions[3].y);
	MaterialFloat3 Local81 = (Local74 * Material.ScalarExpressions[3].z);

	PixelMaterialInputs.EmissiveColor = Local66;
	PixelMaterialInputs.Opacity = Material.ScalarExpressions[3].x;
	PixelMaterialInputs.OpacityMask = Local80;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local81,Material.ScalarExpressions[3].w);
