Shader "Unreal/Translucent_Glass_Safety"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[9] = float4(0.000000,0.000000,0.125000,0.125000);//UVOffsetAndScale
	Material.VectorExpressions[10] = float4(0.000000,0.000000,0.125000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.000000,0.000000,0.125000,0.125000);//(Unknown)
	Material.VectorExpressions[12] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[13] = float4(0.125000,0.125000,0.000000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[3] = float4(0.000000,0.125000,0.000000,0.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
}
