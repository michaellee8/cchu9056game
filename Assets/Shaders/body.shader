		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.854993,0.863157,0.871367,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.854993,0.863157,0.871367,0.000000);//(Unknown)
