		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.318547,0.000000,0.000000,0.760784);//TintColor
	Material.VectorExpressions[3] = float4(0.318547,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.760784,1.000000,5.000000,1.000000);//OpacityAndRefraction
	...
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,1.000000,0.760784);//SpecularAmount RoughnessAmount (Unknown) (Unknown)
