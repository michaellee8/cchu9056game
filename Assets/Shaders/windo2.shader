		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.016807,0.016807,0.016807,0.486275);//TintColor
	Material.VectorExpressions[3] = float4(0.016807,0.016807,0.016807,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.486275,1.000000,5.000000,1.000000);//OpacityAndRefraction
	...
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,1.000000,0.486275);//SpecularAmount RoughnessAmount (Unknown) (Unknown)
