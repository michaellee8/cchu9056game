		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(1.000000,1.000000,1.000000,1.000000);//TintColor
	...
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,0.030000,1.000000);//Autumn IgnoreSeasonsToggle ColorVariationAmount_Autumn ColorVariationTiling
	Material.ScalarExpressions[2] = float4(0.000000,0.500000,0.250000,0.250000);//ColorVariationAmount SpecularAmount RoughnessAmount TranslucencyAmount
	Material.ScalarExpressions[3] = float4(0.000000,0.000000,0.000000,0.000000);//Spring SpringOverride Summer Winter
	Material.ScalarExpressions[4] = float4(2.000000,1.000000,2.000000,0.300000);//WindForce WindToggle (Unknown) LeavesThickness
	Material.ScalarExpressions[5] = float4(0.000000,2.500000,0.000000,0.000000);//__SubsurfaceProfile AOExponent (Unknown) (Unknown)
