		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,1.200000,1.000000);//(Unknown) MetallicAmount RoughnessAmount (Unknown)
	Material.ScalarExpressions[2] = float4(0.200000,0.200000,1.000000,0.000000);//(Unknown) (Unknown) AlphaOpacityMask (Unknown)
