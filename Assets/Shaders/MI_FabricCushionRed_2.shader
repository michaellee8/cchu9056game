Shader "Unreal/MI_FabricCushionRed_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.708376,0.057805,0.064803,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.708376,0.057805,0.064803,0.000000);//(Unknown)
