Shader "Unreal/Object_Charcoal_"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.016807,0.016807,0.016807,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.016807,0.016807,0.016807,0.000000);//(Unknown)
