Shader "Unreal/MI_Bulbfilament_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.000000,6500.000000,100.000000);//UVRotation NormalMapAmount ColorTemperature LuminanceAmount
