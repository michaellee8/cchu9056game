Shader "Unreal/MI_BillboardTrunk_4"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.077000,0.046186,0.021256,1.000000);//TintColor
	Material.VectorExpressions[3] = float4(0.077000,0.046186,0.021256,0.000000);//(Unknown)
