Shader "Unreal/MI_Wood01Tint01_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.296138,0.165132,0.080220,0.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.296138,0.165132,0.080220,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,0.600000,0.600000);//(Unknown) MetallicAmount RoughnessAmount (Unknown)
	Material.ScalarExpressions[2] = float4(-0.400000,0.000000,1.000000,0.000000);//(Unknown) (Unknown) AlphaOpacityMask (Unknown)
