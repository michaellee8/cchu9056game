		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.972000,0.960000,0.915000,0.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.972000,0.960000,0.915000,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[1] = float4(0.000000,1.000000,0.500000,0.500000);//(Unknown) MetallicAmount RoughnessAmount (Unknown)
	Material.ScalarExpressions[2] = float4(-0.500000,0.000000,1.000000,0.000000);//(Unknown) (Unknown) AlphaOpacityMask (Unknown)
