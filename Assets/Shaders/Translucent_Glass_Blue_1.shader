Shader "Unreal/Translucent_Glass_Blue_1"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.127438,0.300544,0.846873,0.501961);//TintColor
	Material.VectorExpressions[3] = float4(0.127438,0.300544,0.846873,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.501961,1.000000,5.000000,1.000000);//OpacityAndRefraction
	...
	Material.ScalarExpressions[1] = float4(1.000000,0.000000,1.000000,0.501961);//SpecularAmount RoughnessAmount (Unknown) (Unknown)
