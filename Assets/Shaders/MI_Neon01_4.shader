		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.000000,0.000000,0.000000,0.000000);//UVSpeed
	...
	Material.VectorExpressions[7] = float4(0.000000,0.000000,0.010000,0.010000);//UVOffsetAndScale
	Material.VectorExpressions[8] = float4(0.000000,0.000000,0.010000,0.000000);//(Unknown)
	Material.VectorExpressions[9] = float4(0.000000,0.000000,0.010000,0.010000);//(Unknown)
	Material.VectorExpressions[10] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.010000,0.010000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(6500.000000,100.000000,0.000000,0.000000);//ColorTemperature LuminanceAmount (Unknown) (Unknown)
	Material.ScalarExpressions[1] = float4(0.000000,0.010000,0.000000,0.000000);//(Unknown) (Unknown) UVRotation (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local34 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 0);
	MaterialFloat4 Local35 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_0, GetMaterialSharedSampler(Material_Texture2D_0Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
	MaterialFloat Local36 = MaterialStoreTexSample(Parameters, Local35, 0);
	MaterialFloat3 Local37 = MaterialExpressionBlackBody(Material.ScalarExpressions[0].x);
	MaterialFloat Local38 = dot(Local37, Local37);
	MaterialFloat Local39 = sqrt(Local38);
	MaterialFloat3 Local40 = (Local37 / Local39);
	MaterialFloat3 Local41 = (Material.VectorExpressions[2].rgb * Local40);
	MaterialFloat3 Local42 = (Material.ScalarExpressions[0].y * Local41);
	MaterialFloat3 Local43 = (Local35.rgb * Local42);
	MaterialFloat3 Local44 = lerp(Local43,Material.VectorExpressions[3].rgb,MaterialFloat(Material.ScalarExpressions[0].z));

	PixelMaterialInputs.EmissiveColor = Local44;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local35.a;
