Shader "Unreal/MI_MetalBlurredBlack_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.000000,0.000000,0.000000,0.000000);//TintColor
	...
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,1.150000,1.000000);//(Unknown) MetallicAmount RoughnessAmount (Unknown)
	Material.ScalarExpressions[2] = float4(0.150000,0.150000,1.000000,0.000000);//(Unknown) (Unknown) AlphaOpacityMask (Unknown)
