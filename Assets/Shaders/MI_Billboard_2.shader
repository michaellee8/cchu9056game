		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.479320,0.539480,0.208637,1.000000);//ColorTint_Summer
	Material.VectorExpressions[3] = float4(0.479320,0.539480,0.208637,0.000000);//(Unknown)
	...
	Material.VectorExpressions[6] = float4(0.078668,0.088542,0.034242,1.000000);//ColorTint_Autumn
	Material.VectorExpressions[7] = float4(0.078668,0.088542,0.034242,0.000000);//(Unknown)
