Shader "Unreal/Arealight(MaterialInstanceDynamic_1)"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(300.000000,300.000000,300.000000,300.000000);//Emissive
	Material.VectorExpressions[2] = float4(300.000000,300.000000,300.000000,0.000000);//(Unknown)
	Material.VectorExpressions[3] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(4500.000000,0.000000,0.000000,0.000000);//Temperature (Unknown) (Unknown) (Unknown)
}void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat3 Local0 = MaterialExpressionBlackBody(Material.ScalarExpressions[0].x);
	MaterialFloat Local1 = dot(Local0, Local0);
	MaterialFloat Local2 = sqrt(Local1);
	MaterialFloat3 Local3 = (Local0 / Local2);
	MaterialFloat3 Local4 = (Local3 * Material.VectorExpressions[2].rgb);
	MaterialFloat3 Local5 = lerp(Local4,Material.VectorExpressions[3].rgb,MaterialFloat(Material.ScalarExpressions[0].y));
