		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.051269,0.051269,0.051269,0.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.051269,0.051269,0.051269,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.200000,6500.000000,0.000000);//UVRotation NormalMapAmount ColorTemperature LuminanceAmount
	Material.ScalarExpressions[1] = float4(0.000000,0.000000,0.500000,0.500000);//(Unknown) MetallicAmount RoughnessAmount (Unknown)
