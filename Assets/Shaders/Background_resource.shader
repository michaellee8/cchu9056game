Shader "Unreal/Background_resource"
{
	Properties
	{
		_MainTex("MainTex (RGB)", 2D) = "white" {}
		Material_Texture2D_0( "LuminanceFilterMap", 2D ) = "white" {}
		Material_Texture2D_1( "SummerColorMap", 2D ) = "white" {}
		Material_Texture2D_2( "AutumnColorMap", 2D ) = "white" {}
		Material_Texture2D_3( "WinterColorMap", 2D ) = "white" {}
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(1.000000,1.000000,1.000000,0.000000);//LuminanceFilter
	...
	Material.ScalarExpressions[0] = float4(6500.000000,3.225806,0.000000,0.000000);//ColorTemperature LuminanceAmount (Unknown) __SubsurfaceProfile
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat4 Local1 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_0, GetMaterialSharedSampler(Material_Texture2D_0Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
	MaterialFloat Local2 = MaterialStoreTexSample(Parameters, Local1, 0);
	MaterialFloat3 Local3 = MaterialExpressionBlackBody(Material.ScalarExpressions[0].x);
	MaterialFloat Local4 = dot(Local3, Local3);
	MaterialFloat Local5 = sqrt(Local4);
	MaterialFloat3 Local6 = (Local3 / Local5);
	MaterialFloat3 Local7 = (Material.VectorExpressions[2].rgb * Local6);
	MaterialFloat3 Local8 = (Material.ScalarExpressions[0].y * Local7);
	MaterialFloat3 Local9 = (Local1.rgb * Local8);
	MaterialFloat3 Local10 = lerp(Local9,Material.VectorExpressions[3].rgb,MaterialFloat(Material.ScalarExpressions[0].z));
	MaterialFloat Local11 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 1);
	MaterialFloat4 Local12 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local13 = MaterialStoreTexSample(Parameters, Local12, 1);
	MaterialFloat4 Local14 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local15 = MaterialStoreTexSample(Parameters, Local14, 1);
	MaterialFloat4 Local16 = MaterialCollection0.Vectors[1];
	MaterialFloat3 Local17 = lerp(Local12.rgb,Local14.rgb,MaterialFloat(Local16.rgba.b));
	MaterialFloat4 Local18 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_3, Material_Texture2D_3Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local19 = MaterialStoreTexSample(Parameters, Local18, 1);
	MaterialFloat3 Local20 = lerp(Local17,Local18.rgb,MaterialFloat(Local16.rgba.a));

	PixelMaterialInputs.EmissiveColor = Local10;
	PixelMaterialInputs.Opacity = 1.00000000;
	PixelMaterialInputs.OpacityMask = Local12.a;
	...
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local20,Material.ScalarExpressions[0].w);
