Shader "Unreal/MI_CarpetWoolVar02_2"
{
	Properties
	{
		...
		Material_Texture2D_2( "TintColorMask", 2D ) = "white" {}
		Material_Texture2D_3( "RoughnessMap", 2D ) = "white" {}
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[2] = float4(0.081597,0.081597,0.081597,1.000000);//TintColor
	Material.VectorExpressions[3] = float4(0.081597,0.081597,0.081597,0.000000);//(Unknown)
	Material.VectorExpressions[4] = float4(0.900000,0.800000,2.000000,1.000000);//Fuzzyness
	...
	Material.VectorExpressions[8] = float4(0.000000,0.000000,4.000000,4.000000);//UVOffsetAndScale
	Material.VectorExpressions[9] = float4(0.000000,0.000000,4.000000,0.000000);//(Unknown)
	Material.VectorExpressions[10] = float4(0.000000,0.000000,4.000000,4.000000);//(Unknown)
	Material.VectorExpressions[11] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[12] = float4(4.000000,4.000000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,1.000000,0.000000,2.000000);//UVRotation NormalMapAmount (Unknown) (Unknown)
	Material.ScalarExpressions[1] = float4(0.800000,0.900000,1.000000,1.000000);//(Unknown) (Unknown) (Unknown) RoughnessAmount
	Material.ScalarExpressions[2] = float4(1.000000,0.000000,0.000000,1.000000);//(Unknown) (Unknown) (Unknown) Subsurface_Opacity
	Material.ScalarExpressions[3] = float4(1.000000,0.000000,0.000000,0.000000);//Subsurface_ColorFactor __SubsurfaceProfile (Unknown) (Unknown)
	Material.ScalarExpressions[4] = float4(4.000000,0.000000,0.000000,0.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat Local48 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 1);
	MaterialFloat4 Local49 = ProcessMaterialColorTextureLookup(Texture2DSample(Material_Texture2D_1, GetMaterialSharedSampler(Material_Texture2D_1Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
	MaterialFloat Local50 = MaterialStoreTexSample(Parameters, Local49, 1);
	MaterialFloat3 Local51 = (Local49.rgb * Material.VectorExpressions[3].rgb);
	MaterialFloat Local52 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 2);
	MaterialFloat4 Local53 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_2, GetMaterialSharedSampler(Material_Texture2D_2Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
	MaterialFloat Local54 = MaterialStoreTexSample(Parameters, Local53, 2);
	MaterialFloat3 Local55 = lerp(Local49.rgb,Local51,Local53.rgb);
	MaterialFloat3 Local56 = (Local46 * MaterialFloat3(MaterialFloat2(1.00000000,1.00000000),Parameters.TwoSidedSign));
	MaterialFloat3 Local57 = mul(Local56, (MaterialFloat3x3)(Parameters.TangentToWorld));
	MaterialFloat Local58 = dot(Parameters.CameraVector, Local57);
	MaterialFloat Local59 = min(max(Local58,0.00000000),1.00000000);
	MaterialFloat Local60 = (1.00000000 - Local59);
	MaterialFloat Local61 = PositiveClampedPow(Local60,Material.ScalarExpressions[0].w);
	MaterialFloat Local62 = (Local61 * Material.ScalarExpressions[1].x);
	MaterialFloat Local63 = (Local59 * Material.ScalarExpressions[1].y);
	MaterialFloat Local64 = (1.00000000 - Local63);
	MaterialFloat Local65 = (Local64 + 0.00000000);
	MaterialFloat Local66 = (Local62 + Local65);
	MaterialFloat3 Local67 = (Local66 * Local55);
	MaterialFloat3 Local68 = lerp(Local55,Local67,MaterialFloat(Material.ScalarExpressions[1].z));
	MaterialFloat Local69 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 3);
	MaterialFloat4 Local70 = ProcessMaterialLinearColorTextureLookup(Texture2DSample(Material_Texture2D_3, GetMaterialSharedSampler(Material_Texture2D_3Sampler,View.MaterialTextureBilinearWrapedSampler),Parameters.TexCoords[0].xy));
	MaterialFloat Local71 = MaterialStoreTexSample(Parameters, Local70, 3);
	MaterialFloat3 Local72 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Local70.rgb,MaterialFloat(Material.ScalarExpressions[2].x));
	MaterialFloat3 Local73 = lerp(Local72,MaterialFloat3(1.00000000,1.00000000,1.00000000),MaterialFloat(Material.ScalarExpressions[2].z));
	MaterialFloat3 Local74 = (Local55 * Material.ScalarExpressions[3].x);

	PixelMaterialInputs.EmissiveColor = Local47;
	PixelMaterialInputs.Opacity = Material.ScalarExpressions[2].w;
	PixelMaterialInputs.OpacityMask = 1.00000000;
	PixelMaterialInputs.BaseColor = Local68;
	PixelMaterialInputs.Metallic = 0.00000000;
	PixelMaterialInputs.Specular = 0.50000000;
	PixelMaterialInputs.Roughness = Local73;
	PixelMaterialInputs.Anisotropy = 0.00000000;
	PixelMaterialInputs.Tangent = MaterialFloat3(1.00000000,0.00000000,0.00000000);
	PixelMaterialInputs.Subsurface = MaterialFloat4(Local74,Material.ScalarExpressions[3].y);
