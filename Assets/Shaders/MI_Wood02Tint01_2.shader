Shader "Unreal/MI_Wood02Tint01_2"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.401978,0.201556,0.135633,0.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.401978,0.201556,0.135633,0.000000);//(Unknown)
	...
	Material.ScalarExpressions[0] = float4(0.000000,0.250000,6500.000000,0.000000);//UVRotation NormalMapAmount ColorTemperature LuminanceAmount
