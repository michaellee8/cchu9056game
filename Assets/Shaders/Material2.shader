		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.223228,0.262251,1.000000,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.223228,0.262251,1.000000,0.000000);//(Unknown)
