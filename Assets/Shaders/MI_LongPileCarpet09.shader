Shader "Unreal/MI_LongPileCarpet09"
{
	Properties
	{
		...
		Material_Texture2D_2( "HeightMap", 2D ) = "white" {}
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[1] = float4(0.000000,0.000000,1.000000,1.000000);//UVOffsetAndScale
	...
	Material.VectorExpressions[5] = float4(1.000000,1.000000,1.000000,0.000000);//TintColor
	Material.VectorExpressions[6] = float4(1.000000,1.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[7] = float4(0.900000,0.800000,2.000000,1.000000);//Fuzzyness
	Material.VectorExpressions[8] = float4(0.000000,0.000000,0.000000,0.000000);//UVSpeed
	...
	Material.VectorExpressions[11] = float4(0.000000,0.000000,1.000000,0.000000);//(Unknown)
	Material.VectorExpressions[12] = float4(0.000000,0.000000,1.000000,1.000000);//(Unknown)
	Material.VectorExpressions[13] = float4(0.000000,0.000000,0.000000,0.000000);//(Unknown)
	Material.VectorExpressions[14] = float4(1.000000,1.000000,0.000000,0.000000);//(Unknown)
	Material.ScalarExpressions[0] = float4(0.000000,1.000000,1.000000,0.000000);//UVRotation (Unknown) (Unknown) (Unknown)
	Material.ScalarExpressions[1] = float4(0.000000,4.000000,1.000000,0.000000);//(Unknown) HeightmapTiling NormalMapAmount (Unknown)
	Material.ScalarExpressions[2] = float4(2.000000,0.800000,0.900000,1.000000);//(Unknown) (Unknown) (Unknown) (Unknown)
	Material.ScalarExpressions[3] = float4(1.000000,0.000000,0.000000,0.000000);//AOAmount (Unknown) (Unknown) (Unknown)
}
...
void CalcPixelMaterialInputs(in out FMaterialPixelParameters Parameters, in out FPixelMaterialInputs PixelMaterialInputs)
{
	...
	MaterialFloat2 Local36 = (Parameters.TexCoords[0].xy / Material.VectorExpressions[2].rg);
	MaterialFloat2 Local37 = (Local36 - Material.VectorExpressions[3].rg);
	MaterialFloat2 Local38 = (Local37 * Material.ScalarExpressions[1].y);
	MaterialFloat Local39 = MaterialStoreTexCoordScale(Parameters, Local38, 1);
	MaterialFloat4 Local40 = UnpackNormalMap(Texture2DSample(Material_Texture2D_0, GetMaterialSharedSampler(Material_Texture2D_0Sampler,View.MaterialTextureBilinearWrapedSampler),Local38));
	MaterialFloat Local41 = MaterialStoreTexSample(Parameters, Local40, 1);
	MaterialFloat3 Local42 = (MaterialFloat3(MaterialFloat2(Local34.g,Local35),0.00000000) * Local40.rgb.r);
	MaterialFloat3 Local43 = (MaterialFloat3(MaterialFloat2(Local34.r,Local34.g),0.00000000) * Local40.rgb.g);
	MaterialFloat3 Local44 = (Local42 + Local43);
	MaterialFloat3 Local45 = (MaterialFloat3(0.00000000,0.00000000,1.00000000) * Local40.rgb.b);
	MaterialFloat3 Local46 = (Local45 + MaterialFloat3(0.00000000,0.00000000,0.00000000));
	MaterialFloat3 Local47 = (Local44 + Local46);
	MaterialFloat2 Local48 = (Local47.rg * Parameters.TwoSidedSign);
	MaterialFloat3 Local49 = lerp(MaterialFloat3(0.00000000,0.00000000,1.00000000),MaterialFloat3(Local48,Local47.b),MaterialFloat(Material.ScalarExpressions[1].z));
	...
	MaterialFloat3 Local50 = lerp(MaterialFloat3(0.00000000,0.00000000,0.00000000),Material.VectorExpressions[4].rgb,MaterialFloat(Material.ScalarExpressions[1].w));
	MaterialFloat Local51 = MaterialStoreTexCoordScale(Parameters, Parameters.TexCoords[0].xy, 2);
	MaterialFloat4 Local52 = ProcessMaterialColorTextureLookup(Texture2DSampleBias(Material_Texture2D_1, Material_Texture2D_1Sampler,Parameters.TexCoords[0].xy,View.MaterialTextureMipBias));
	MaterialFloat Local53 = MaterialStoreTexSample(Parameters, Local52, 2);
	MaterialFloat3 Local54 = (Local52.rgb * Material.VectorExpressions[6].rgb);
	MaterialFloat3 Local55 = (Local49 * MaterialFloat3(MaterialFloat2(1.00000000,1.00000000),Parameters.TwoSidedSign));
	MaterialFloat3 Local56 = mul(Local55, (MaterialFloat3x3)(Parameters.TangentToWorld));
	MaterialFloat Local57 = dot(Parameters.CameraVector, Local56);
	MaterialFloat Local58 = min(max(Local57,0.00000000),1.00000000);
	MaterialFloat Local59 = (1.00000000 - Local58);
	MaterialFloat Local60 = PositiveClampedPow(Local59,Material.ScalarExpressions[2].x);
	MaterialFloat Local61 = (Local60 * Material.ScalarExpressions[2].y);
	MaterialFloat Local62 = (Local58 * Material.ScalarExpressions[2].z);
	MaterialFloat Local63 = (1.00000000 - Local62);
	MaterialFloat Local64 = (Local63 + 0.00000000);
	MaterialFloat Local65 = (Local61 + Local64);
	MaterialFloat3 Local66 = (Local65 * Local54);
	MaterialFloat3 Local67 = lerp(Local54,Local66,MaterialFloat(Material.ScalarExpressions[2].w));
	MaterialFloat Local68 = MaterialStoreTexCoordScale(Parameters, Local38, 3);
	MaterialFloat4 Local69 = ProcessMaterialLinearColorTextureLookup(Texture2DSampleBias(Material_Texture2D_2, Material_Texture2D_2Sampler,Local38,View.MaterialTextureMipBias));
	MaterialFloat Local70 = MaterialStoreTexSample(Parameters, Local69, 3);
	MaterialFloat Local71 = (Local69.g + 0.50000000);
	MaterialFloat Local72 = (Local69.r * Material.ScalarExpressions[3].x);
	...
	PixelMaterialInputs.Roughness = Local71;
