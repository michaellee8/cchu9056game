Shader "Unreal/MI_MetalStreetGrey"
{
	Properties
	{
		...
		MaterialStruct Material;void InitializeExpressions()
{
	...
	Material.VectorExpressions[4] = float4(0.223228,0.212231,0.201556,1.000000);//TintColor
	Material.VectorExpressions[5] = float4(0.223228,0.212231,0.201556,0.000000);//(Unknown)
